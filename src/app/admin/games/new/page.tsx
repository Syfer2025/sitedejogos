      ...
      <header className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-slate-400 mt-1">
            Cadastre um novo jogo HTML5 para aparecer na home e na página de
            jogo.
          </p>
        </div>
      </header>
      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-3">
          <div className="space-y-1.5">
            ...
            <input
              ...
              placeholder="Ex: Cyber Drift Racer"
            />
          </div>
          <div className="space-y-1.5">
            <label className="block text-slate-300 text-[11px]">
            ...
            <input
              name="category"
              className="w-full rounded-md bg-slate-900/80 border border-slate-700/80 px-2 py-1 text-xs text-slate-100 focus:outline-none focus:ring-1 focus:ring-purple-500/70"
              placeholder="Ex: Racing, Arcade, Shooter"
            />
          </div>
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <textarea
            ...
            placeholder="Texto que aparece na página de jogo e na home."
          />
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <input
            name="tags"
            className="w-full rounded-md bg-slate-900/80 border border-slate-700/80 px-2 py-1 text-xs text-slate-100 focus:outline-none focus:ring-1 focus:ring-purple-500/70"
            placeholder="Ex: corrida, neon, html5"
          />
        </div>
