  ...
  return (
    <div className="h-full overflow-y-auto scrollbar-thin">
      <div className="min-h-full bg-gradient-to-b from-slate-950 via-slate-900 to-black flex items-center justify-center px-4">
        <div className="w-full max-w-[420px] rounded-2xl border border-slate-800 bg-slate-950/80 p-8 text-center shadow-[0_0_50px_rgba(15,23,42,0.9)] scale-95 md:scale-100 transition-transform">
          {status === "loading" && (
            <>
