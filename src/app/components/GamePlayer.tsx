...
export function GamePlayer({ iframeUrl, title }: GamePlayerProps) {
  ...
  const handleStartGame = () => {
    // Phase 3: AdSense API for Games (H5/AFG) Interstitial Mock
    // No futuro, aqui disparamos: adBreak({ type: 'start', name: title, ... })
    setIsShowingAd(true);
  ...
  return (
    <>
      ...
      >
        ...
        {hasStarted && (
          <>
            {/* Loading skeleton while iframe fetches */}
            {!loaded && (
